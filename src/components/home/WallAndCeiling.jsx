...
// ..
AOS.init();
const WallAndCeiling = () => {
	return (
		<div className='mt-12 lg:mt-20   lg:mb-20 bg-[#BCA9CC] rounded-3xl pb-5'>
			<h1 className='lg:text-4xl text-xl font-bold text-shadow-xl drop-shadow-[4px_4px_5px_rgba(0,0,0,0.7)] text-center pt-12 pb-8'>Wall and Ceiling Panels</h1>
			...
			<div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10 p-2 justify-items-center mx-auto'>
                ...
                py-2 text-sm font-semibold">
						3D PVC Wall and Ceiling Panels
					</p>
				</div>
				<div className="relative  lg:w-[340px]  lg:h-[340px] w-[140px] h-[140px]" data-aos="zoom-in"  data-aos-duration="3000">
					{/* Image */}
